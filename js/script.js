...
console.log(
  `jadi rata-rata nilai dari murid tersebut adalah ${rataRata} yang berarti ${result}`
);
...
// console.log(
//   `${angka} adalah seorang pegawai bergolong ${g}, lahir pada tanggal ${dd} ${namaBulan} ${yyyy} dan bernomor urut ${nn}`
// );
...
console.log(
  `${angka} adalah seorang pegawai bergolong ${g}, lahir pada tanggal ${dd} ${bulan} ${yyyy} dan bernomor urut ${nn}`
);
...
if (detik > 59) {
  ...
  console.log(
    `jadi bila kita menambahkan 1 detik maka waktu yang akan keluar adalah ${hasilJ} : ${hasilM} : ${hasil}`
  );
} else {
  console.log(
